...
public class HeartBeatRespHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        if (message.getHeader() != null && message.getHeader().getType() == MessageType.HEARTBEAT_REQ.value()) {
            ...
            LOGGER.info("RCV HEART REQ {} ---> {} with message {} ", heartBeanFromAddressInfo, serverAddressInfo, message);
            NettyMessage heartBeat = NettyMessageFactory.newHeartBeanResp();
            LOGGER.info("SNT BACK HEART RSP {} ---> {} with message {} ", serverAddressInfo, heartBeanFromAddressInfo, message);
